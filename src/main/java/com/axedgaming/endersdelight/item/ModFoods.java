...
public class ModFoods {
    ...
    public static final FoodProperties ENDER_PAELLA = (new FoodProperties.Builder().nutrition(4).saturationMod(0.4F).effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 1800, 0), 1F)).build();
